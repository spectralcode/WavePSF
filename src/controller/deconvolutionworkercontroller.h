#ifndef DECONVOLUTIONWORKERCONTROLLER_H
#define DECONVOLUTIONWORKERCONTROLLER_H

#include <QObject>
#include <QThread>
#include "core/processing/deconvolutionworker.h"

class DeconvolutionWorkerController : public QObject
{
	Q_OBJECT

public:
	explicit DeconvolutionWorkerController(QObject* parent = nullptr);
	~DeconvolutionWorkerController() override;
...
#endif // DECONVOLUTIONWORKERCONTROLLER_H
